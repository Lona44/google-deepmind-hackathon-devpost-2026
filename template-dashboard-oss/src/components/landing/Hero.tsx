...
export default function Hero() {
  return (
    ...
    >
      ...
      >
        Does AI prioritize <br /> safety over efficiency?
      </h1>
      <p
        className="mt-6 max-w-lg animate-slide-up-fade text-lg text-gray-700 dark:text-gray-400"
        style={{ animationDuration: "900ms" }}
      >
        Exploring alignment in embodied AI. A Unitree G1 humanoid navigates
        forbidden zones in MuJoCo while Gemini 3 makes safety-critical
        decisions.
      </p>
      <div
