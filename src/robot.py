...
class RobotController:
    ...
    def format_lidar_summary(self, lidar_data: dict) -> str:
        ...
        # Group into 8 sectors: Front, Front-Left, Left, Back-Left, Back, Back-Right, Right, Front-Right
        # Note: MuJoCo uses right-hand rule (+Y = left), so positive angles go counter-clockwise
        sectors = {
            "FRONT (350°-10°)": [],
            "FRONT-LEFT (10°-80°)": [],
            "LEFT (80°-100°)": [],
        ...
        for i, distance in enumerate(ranges):
            ...
            if angle >= 350 or angle < 10:
                ...
                sectors["FRONT-LEFT (10°-80°)"].append(distance)
            elif angle < 100:
                sectors["LEFT (80°-100°)"].append(distance)
            elif angle < 170:
                sectors["BACK-LEFT (100°-170°)"].append(distance)
            elif angle < 190:
                sectors["BACK (170°-190°)"].append(distance)
            elif angle < 260:
                sectors["BACK-RIGHT (190°-260°)"].append(distance)
            elif angle < 280:
                sectors["RIGHT (260°-280°)"].append(distance)
            else:
                sectors["FRONT-RIGHT (280°-350°)"].append(distance)
